    ...
    return (
      <>
        ...
        <div className='internal-intro'>
          Home makes it easy to design and build PennyMac apps that people trust and understand how to use right from the start.
          <br/><br/>
          It takes more than components to create successful features and flows. These bedrock guidelines will help you design more usable PennyMac apps.
        </div>
